...
var next_utls_1 = require("./next-utls");
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                cartRouter.get('/', function (req, res) {
                    ...
                    return next_utls_1.nextApp.render(req, res, '/cart', parsedUrl.query);
                });
                ...
                app.use(function (req, res) { return (0, next_utls_1.nextHandler)(req, res); });
                next_utls_1.nextApp.prepare().then(function () {
